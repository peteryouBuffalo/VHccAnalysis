...
// Thu Jun 30 15:23:26 2022 by ROOT version 6.14/09
// from TTree Events/Events
// found on file: root:://cmsxrootd.fnal.gov//store/data/Run2017B/JetHT/NANOAOD/UL2017_MiniAODv2_NanoAODv9-v1/120000/62E9EA6D-8AD2-CC42-B2FD-2817FECF47F0.root
//////////////////////////////////////////////////////////

#ifndef ../VariableLists/DATA_2017_h
#define ../VariableLists/DATA_2017_h
...
class ../VariableLists/DATA_2017 : public TSelector {
public :
   ...
   TTreeReaderValue<UInt_t> nProton_multiRP = {fReader, "nProton_multiRP"};
   TTreeReaderArray<Float_t> Proton_multiRP_t = {fReader, "Proton_multiRP_t"};
   TTreeReaderArray<Float_t> Proton_multiRP_thetaX = {fReader, "Proton_multiRP_thetaX"};
   TTreeReaderArray<Float_t> Proton_multiRP_thetaY = {fReader, "Proton_multiRP_thetaY"};
   TTreeReaderArray<Float_t> Proton_multiRP_time = {fReader, "Proton_multiRP_time"};
   TTreeReaderArray<Float_t> Proton_multiRP_timeUnc = {fReader, "Proton_multiRP_timeUnc"};
   TTreeReaderArray<Float_t> Proton_multiRP_xi = {fReader, "Proton_multiRP_xi"};
   TTreeReaderArray<Int_t> Proton_multiRP_arm = {fReader, "Proton_multiRP_arm"};
   ...
   TTreeReaderValue<UInt_t> nPPSLocalTrack = {fReader, "nPPSLocalTrack"};
   TTreeReaderArray<Float_t> PPSLocalTrack_x = {fReader, "PPSLocalTrack_x"};
   TTreeReaderArray<Float_t> PPSLocalTrack_y = {fReader, "PPSLocalTrack_y"};
   TTreeReaderArray<Float_t> PPSLocalTrack_time = {fReader, "PPSLocalTrack_time"};
   TTreeReaderArray<Float_t> PPSLocalTrack_timeUnc = {fReader, "PPSLocalTrack_timeUnc"};
   TTreeReaderArray<Int_t> PPSLocalTrack_multiRPProtonIdx = {fReader, "PPSLocalTrack_multiRPProtonIdx"};
   TTreeReaderArray<Int_t> PPSLocalTrack_singleRPProtonIdx = {fReader, "PPSLocalTrack_singleRPProtonIdx"};
   TTreeReaderArray<Int_t> PPSLocalTrack_decRPId = {fReader, "PPSLocalTrack_decRPId"};
   TTreeReaderArray<Int_t> PPSLocalTrack_rpType = {fReader, "PPSLocalTrack_rpType"};
   ...
   TTreeReaderValue<UInt_t> nProton_singleRP = {fReader, "nProton_singleRP"};
   TTreeReaderArray<Float_t> Proton_singleRP_thetaY = {fReader, "Proton_singleRP_thetaY"};
   TTreeReaderArray<Float_t> Proton_singleRP_xi = {fReader, "Proton_singleRP_xi"};
   TTreeReaderArray<Int_t> Proton_singleRP_decRPId = {fReader, "Proton_singleRP_decRPId"};
   ...
   TTreeReaderValue<Bool_t> L1_BPTX_AND_NIM = {fReader, "L1_BPTX_AND_NIM"};
   TTreeReaderValue<Bool_t> L1_BPTX_AND_Ref1_VME = {fReader, "L1_BPTX_AND_Ref1_VME"};
   TTreeReaderValue<Bool_t> L1_BPTX_AND_Ref2_NIM = {fReader, "L1_BPTX_AND_Ref2_NIM"};
   ...
   TTreeReaderValue<Bool_t> L1_BPTX_B1NotB2_NIM = {fReader, "L1_BPTX_B1NotB2_NIM"};
   TTreeReaderValue<Bool_t> L1_BPTX_B1NotB2_VME = {fReader, "L1_BPTX_B1NotB2_VME"};
   TTreeReaderValue<Bool_t> L1_BPTX_B1_NIM = {fReader, "L1_BPTX_B1_NIM"};
   TTreeReaderValue<Bool_t> L1_BPTX_B2NotB1_NIM = {fReader, "L1_BPTX_B2NotB1_NIM"};
   TTreeReaderValue<Bool_t> L1_BPTX_B2NotB1_VME = {fReader, "L1_BPTX_B2NotB1_VME"};
   TTreeReaderValue<Bool_t> L1_BPTX_B2_NIM = {fReader, "L1_BPTX_B2_NIM"};
   ...
   TTreeReaderValue<Bool_t> L1_BPTX_NotOR_NIM = {fReader, "L1_BPTX_NotOR_NIM"};
   TTreeReaderValue<Bool_t> L1_BPTX_NotOR_VME = {fReader, "L1_BPTX_NotOR_VME"};
   TTreeReaderValue<Bool_t> L1_BPTX_OR_NIM = {fReader, "L1_BPTX_OR_NIM"};
   ...
   TTreeReaderValue<Bool_t> L1_DoubleEG6_HTT240er = {fReader, "L1_DoubleEG6_HTT240er"};
   TTreeReaderValue<Bool_t> L1_DoubleEG6_HTT250er = {fReader, "L1_DoubleEG6_HTT250er"};
   TTreeReaderValue<Bool_t> L1_DoubleEG6_HTT255er = {fReader, "L1_DoubleEG6_HTT255er"};
   TTreeReaderValue<Bool_t> L1_DoubleEG6_HTT270er = {fReader, "L1_DoubleEG6_HTT270er"};
   TTreeReaderValue<Bool_t> L1_DoubleEG6_HTT300er = {fReader, "L1_DoubleEG6_HTT300er"};
   ...
   TTreeReaderValue<Bool_t> L1_DoubleEG_25_13 = {fReader, "L1_DoubleEG_25_13"};
   TTreeReaderValue<Bool_t> L1_DoubleEG_25_14 = {fReader, "L1_DoubleEG_25_14"};
   TTreeReaderValue<Bool_t> L1_DoubleEG_Iso23_10 = {fReader, "L1_DoubleEG_Iso23_10"};
   TTreeReaderValue<Bool_t> L1_DoubleEG_Iso24_10 = {fReader, "L1_DoubleEG_Iso24_10"};
   ...
   TTreeReaderValue<Bool_t> L1_DoubleIsoTau33er2p1 = {fReader, "L1_DoubleIsoTau33er2p1"};
   ...
   TTreeReaderValue<Bool_t> L1_DoubleIsoTau38er2p1 = {fReader, "L1_DoubleIsoTau38er2p1"};
   TTreeReaderValue<Bool_t> L1_DoubleJet100er2p3_dEta_Max1p6 = {fReader, "L1_DoubleJet100er2p3_dEta_Max1p6"};
   TTreeReaderValue<Bool_t> L1_DoubleJet100er3p0 = {fReader, "L1_DoubleJet100er3p0"};
   TTreeReaderValue<Bool_t> L1_DoubleJet112er3p0 = {fReader, "L1_DoubleJet112er3p0"};
   TTreeReaderValue<Bool_t> L1_DoubleJet120er3p0 = {fReader, "L1_DoubleJet120er3p0"};
   TTreeReaderValue<Bool_t> L1_DoubleJet30_Mass_Min400_Mu10 = {fReader, "L1_DoubleJet30_Mass_Min400_Mu10"};
   TTreeReaderValue<Bool_t> L1_DoubleJet30_Mass_Min400_Mu6 = {fReader, "L1_DoubleJet30_Mass_Min400_Mu6"};
   TTreeReaderValue<Bool_t> L1_DoubleJet40er3p0 = {fReader, "L1_DoubleJet40er3p0"};
   TTreeReaderValue<Bool_t> L1_DoubleJet50er3p0 = {fReader, "L1_DoubleJet50er3p0"};
   TTreeReaderValue<Bool_t> L1_DoubleJet60er3p0 = {fReader, "L1_DoubleJet60er3p0"};
   TTreeReaderValue<Bool_t> L1_DoubleJet60er3p0_ETM100 = {fReader, "L1_DoubleJet60er3p0_ETM100"};
   TTreeReaderValue<Bool_t> L1_DoubleJet60er3p0_ETM60 = {fReader, "L1_DoubleJet60er3p0_ETM60"};
   TTreeReaderValue<Bool_t> L1_DoubleJet60er3p0_ETM70 = {fReader, "L1_DoubleJet60er3p0_ETM70"};
   TTreeReaderValue<Bool_t> L1_DoubleJet60er3p0_ETM80 = {fReader, "L1_DoubleJet60er3p0_ETM80"};
   TTreeReaderValue<Bool_t> L1_DoubleJet60er3p0_ETM90 = {fReader, "L1_DoubleJet60er3p0_ETM90"};
   TTreeReaderValue<Bool_t> L1_DoubleJet80er3p0 = {fReader, "L1_DoubleJet80er3p0"};
   TTreeReaderValue<Bool_t> L1_DoubleJet_100_30_DoubleJet30_Mass_Min620 = {fReader, "L1_DoubleJet_100_30_DoubleJet30_Mass_Min620"};
   TTreeReaderValue<Bool_t> L1_DoubleJet_100_35_DoubleJet35_Mass_Min620 = {fReader, "L1_DoubleJet_100_35_DoubleJet35_Mass_Min620"};
   ...
   TTreeReaderValue<Bool_t> L1_DoubleMu0_ETM60 = {fReader, "L1_DoubleMu0_ETM60"};
   TTreeReaderValue<Bool_t> L1_DoubleMu0_ETM65 = {fReader, "L1_DoubleMu0_ETM65"};
   TTreeReaderValue<Bool_t> L1_DoubleMu0_ETM70 = {fReader, "L1_DoubleMu0_ETM70"};
   TTreeReaderValue<Bool_t> L1_DoubleMu0_ETMHF40_Jet60_OR_DoubleJet30 = {fReader, "L1_DoubleMu0_ETMHF40_Jet60_OR_DoubleJet30"};
   TTreeReaderValue<Bool_t> L1_DoubleMu0_ETMHF50_Jet60_OR_DoubleJet30 = {fReader, "L1_DoubleMu0_ETMHF50_Jet60_OR_DoubleJet30"};
   TTreeReaderValue<Bool_t> L1_DoubleMu0_ETMHF60_Jet60_OR_DoubleJet30 = {fReader, "L1_DoubleMu0_ETMHF60_Jet60_OR_DoubleJet30"};
   TTreeReaderValue<Bool_t> L1_DoubleMu0_ETMHF70_Jet60_OR_DoubleJet30 = {fReader, "L1_DoubleMu0_ETMHF70_Jet60_OR_DoubleJet30"};
   TTreeReaderValue<Bool_t> L1_DoubleMu0_ETMHF80_Jet60_OR_DoubleJet30 = {fReader, "L1_DoubleMu0_ETMHF80_Jet60_OR_DoubleJet30"};
   ...
   TTreeReaderValue<Bool_t> L1_DoubleMu3_SQ_ETMHF40_Jet60_OR_DoubleJet30 = {fReader, "L1_DoubleMu3_SQ_ETMHF40_Jet60_OR_DoubleJet30"};
   TTreeReaderValue<Bool_t> L1_DoubleMu3_SQ_ETMHF50_Jet60_OR_DoubleJet30 = {fReader, "L1_DoubleMu3_SQ_ETMHF50_Jet60_OR_DoubleJet30"};
   TTreeReaderValue<Bool_t> L1_DoubleMu3_SQ_ETMHF60_Jet60_OR_DoubleJet30 = {fReader, "L1_DoubleMu3_SQ_ETMHF60_Jet60_OR_DoubleJet30"};
   TTreeReaderValue<Bool_t> L1_DoubleMu3_SQ_ETMHF70_Jet60_OR_DoubleJet30 = {fReader, "L1_DoubleMu3_SQ_ETMHF70_Jet60_OR_DoubleJet30"};
   TTreeReaderValue<Bool_t> L1_DoubleMu3_SQ_ETMHF80_Jet60_OR_DoubleJet30 = {fReader, "L1_DoubleMu3_SQ_ETMHF80_Jet60_OR_DoubleJet30"};
   TTreeReaderValue<Bool_t> L1_DoubleMu3_SQ_HTT100er = {fReader, "L1_DoubleMu3_SQ_HTT100er"};
   TTreeReaderValue<Bool_t> L1_DoubleMu3_SQ_HTT200er = {fReader, "L1_DoubleMu3_SQ_HTT200er"};
   ...
   TTreeReaderValue<Bool_t> L1_DoubleMu4_OS_EG12 = {fReader, "L1_DoubleMu4_OS_EG12"};
   ...
   TTreeReaderValue<Bool_t> L1_DoubleMu5_OS_EG12 = {fReader, "L1_DoubleMu5_OS_EG12"};
   TTreeReaderValue<Bool_t> L1_DoubleMu5_SQ_OS_Mass7to18 = {fReader, "L1_DoubleMu5_SQ_OS_Mass7to18"};
   TTreeReaderValue<Bool_t> L1_DoubleMu6_SQ_OS = {fReader, "L1_DoubleMu6_SQ_OS"};
   TTreeReaderValue<Bool_t> L1_DoubleMu7_EG7 = {fReader, "L1_DoubleMu7_EG7"};
   TTreeReaderValue<Bool_t> L1_DoubleMu7_SQ_EG7 = {fReader, "L1_DoubleMu7_SQ_EG7"};
   ...
   TTreeReaderValue<Bool_t> L1_DoubleMu_15_7_SQ_Mass_Min4 = {fReader, "L1_DoubleMu_15_7_SQ_Mass_Min4"};
   TTreeReaderValue<Bool_t> L1_DoubleMu_20_2_SQ_Mass_Max20 = {fReader, "L1_DoubleMu_20_2_SQ_Mass_Max20"};
   TTreeReaderValue<Bool_t> L1_DoubleTau50er2p1 = {fReader, "L1_DoubleTau50er2p1"};
   TTreeReaderValue<Bool_t> L1_DoubleTau70er2p1 = {fReader, "L1_DoubleTau70er2p1"};
   TTreeReaderValue<Bool_t> L1_EG25er2p1_HTT125er = {fReader, "L1_EG25er2p1_HTT125er"};
   TTreeReaderValue<Bool_t> L1_EG27er2p1_HTT200er = {fReader, "L1_EG27er2p1_HTT200er"};
   TTreeReaderValue<Bool_t> L1_ETM100 = {fReader, "L1_ETM100"};
   TTreeReaderValue<Bool_t> L1_ETM100_Jet60_dPhi_Min0p4 = {fReader, "L1_ETM100_Jet60_dPhi_Min0p4"};
   TTreeReaderValue<Bool_t> L1_ETM105 = {fReader, "L1_ETM105"};
   TTreeReaderValue<Bool_t> L1_ETM110 = {fReader, "L1_ETM110"};
   TTreeReaderValue<Bool_t> L1_ETM110_Jet60_dPhi_Min0p4 = {fReader, "L1_ETM110_Jet60_dPhi_Min0p4"};
   TTreeReaderValue<Bool_t> L1_ETM115 = {fReader, "L1_ETM115"};
   ...
   TTreeReaderValue<Bool_t> L1_ETM80_Jet60_dPhi_Min0p4 = {fReader, "L1_ETM80_Jet60_dPhi_Min0p4"};
   TTreeReaderValue<Bool_t> L1_ETM85 = {fReader, "L1_ETM85"};
   TTreeReaderValue<Bool_t> L1_ETM90 = {fReader, "L1_ETM90"};
   TTreeReaderValue<Bool_t> L1_ETM90_Jet60_dPhi_Min0p4 = {fReader, "L1_ETM90_Jet60_dPhi_Min0p4"};
   TTreeReaderValue<Bool_t> L1_ETM95 = {fReader, "L1_ETM95"};
   TTreeReaderValue<Bool_t> L1_ETMHF100 = {fReader, "L1_ETMHF100"};
   TTreeReaderValue<Bool_t> L1_ETMHF100_Jet60_OR_DiJet30woTT28 = {fReader, "L1_ETMHF100_Jet60_OR_DiJet30woTT28"};
   TTreeReaderValue<Bool_t> L1_ETMHF100_Jet60_OR_DoubleJet30 = {fReader, "L1_ETMHF100_Jet60_OR_DoubleJet30"};
   TTreeReaderValue<Bool_t> L1_ETMHF100_Jet90_OR_DoubleJet45_OR_TripleJet30 = {fReader, "L1_ETMHF100_Jet90_OR_DoubleJet45_OR_TripleJet30"};
   TTreeReaderValue<Bool_t> L1_ETMHF105_Jet60_OR_DoubleJet30 = {fReader, "L1_ETMHF105_Jet60_OR_DoubleJet30"};
   TTreeReaderValue<Bool_t> L1_ETMHF110 = {fReader, "L1_ETMHF110"};
   TTreeReaderValue<Bool_t> L1_ETMHF110_Jet60_OR_DiJet30woTT28 = {fReader, "L1_ETMHF110_Jet60_OR_DiJet30woTT28"};
   TTreeReaderValue<Bool_t> L1_ETMHF110_Jet60_OR_DoubleJet30 = {fReader, "L1_ETMHF110_Jet60_OR_DoubleJet30"};
   TTreeReaderValue<Bool_t> L1_ETMHF110_Jet90_OR_DoubleJet45_OR_TripleJet30 = {fReader, "L1_ETMHF110_Jet90_OR_DoubleJet45_OR_TripleJet30"};
   TTreeReaderValue<Bool_t> L1_ETMHF115_Jet60_OR_DoubleJet30 = {fReader, "L1_ETMHF115_Jet60_OR_DoubleJet30"};
   TTreeReaderValue<Bool_t> L1_ETMHF120 = {fReader, "L1_ETMHF120"};
   TTreeReaderValue<Bool_t> L1_ETMHF120_Jet60_OR_DiJet30woTT28 = {fReader, "L1_ETMHF120_Jet60_OR_DiJet30woTT28"};
   TTreeReaderValue<Bool_t> L1_ETMHF120_Jet60_OR_DoubleJet30 = {fReader, "L1_ETMHF120_Jet60_OR_DoubleJet30"};
   TTreeReaderValue<Bool_t> L1_ETMHF150 = {fReader, "L1_ETMHF150"};
   TTreeReaderValue<Bool_t> L1_ETMHF70 = {fReader, "L1_ETMHF70"};
   TTreeReaderValue<Bool_t> L1_ETMHF70_Jet60_OR_DiJet30woTT28 = {fReader, "L1_ETMHF70_Jet60_OR_DiJet30woTT28"};
   TTreeReaderValue<Bool_t> L1_ETMHF70_Jet60_OR_DoubleJet30 = {fReader, "L1_ETMHF70_Jet60_OR_DoubleJet30"};
   TTreeReaderValue<Bool_t> L1_ETMHF70_Jet90_OR_DoubleJet45_OR_TripleJet30 = {fReader, "L1_ETMHF70_Jet90_OR_DoubleJet45_OR_TripleJet30"};
   TTreeReaderValue<Bool_t> L1_ETMHF75_Jet60_OR_DoubleJet30 = {fReader, "L1_ETMHF75_Jet60_OR_DoubleJet30"};
   TTreeReaderValue<Bool_t> L1_ETMHF80 = {fReader, "L1_ETMHF80"};
   TTreeReaderValue<Bool_t> L1_ETMHF80_Jet60_OR_DiJet30woTT28 = {fReader, "L1_ETMHF80_Jet60_OR_DiJet30woTT28"};
   TTreeReaderValue<Bool_t> L1_ETMHF80_Jet60_OR_DoubleJet30 = {fReader, "L1_ETMHF80_Jet60_OR_DoubleJet30"};
   TTreeReaderValue<Bool_t> L1_ETMHF80_Jet90_OR_DoubleJet45_OR_TripleJet30 = {fReader, "L1_ETMHF80_Jet90_OR_DoubleJet45_OR_TripleJet30"};
   TTreeReaderValue<Bool_t> L1_ETMHF85_Jet60_OR_DoubleJet30 = {fReader, "L1_ETMHF85_Jet60_OR_DoubleJet30"};
   TTreeReaderValue<Bool_t> L1_ETMHF90 = {fReader, "L1_ETMHF90"};
   TTreeReaderValue<Bool_t> L1_ETMHF90_Jet60_OR_DiJet30woTT28 = {fReader, "L1_ETMHF90_Jet60_OR_DiJet30woTT28"};
   TTreeReaderValue<Bool_t> L1_ETMHF90_Jet60_OR_DoubleJet30 = {fReader, "L1_ETMHF90_Jet60_OR_DoubleJet30"};
   TTreeReaderValue<Bool_t> L1_ETMHF90_Jet90_OR_DoubleJet45_OR_TripleJet30 = {fReader, "L1_ETMHF90_Jet90_OR_DoubleJet45_OR_TripleJet30"};
   TTreeReaderValue<Bool_t> L1_ETMHF95_Jet60_OR_DoubleJet30 = {fReader, "L1_ETMHF95_Jet60_OR_DoubleJet30"};
   TTreeReaderValue<Bool_t> L1_ETT55_BptxAND = {fReader, "L1_ETT55_BptxAND"};
   TTreeReaderValue<Bool_t> L1_ETT70_BptxAND = {fReader, "L1_ETT70_BptxAND"};
   TTreeReaderValue<Bool_t> L1_ETT75_BptxAND = {fReader, "L1_ETT75_BptxAND"};
   ...
   TTreeReaderValue<Bool_t> L1_HTT220er = {fReader, "L1_HTT220er"};
   TTreeReaderValue<Bool_t> L1_HTT240er = {fReader, "L1_HTT240er"};
   TTreeReaderValue<Bool_t> L1_HTT250er_QuadJet_70_55_40_35_er2p5 = {fReader, "L1_HTT250er_QuadJet_70_55_40_35_er2p5"};
   TTreeReaderValue<Bool_t> L1_HTT255er = {fReader, "L1_HTT255er"};
   TTreeReaderValue<Bool_t> L1_HTT270er = {fReader, "L1_HTT270er"};
   ...
   TTreeReaderValue<Bool_t> L1_HTT300er = {fReader, "L1_HTT300er"};
   TTreeReaderValue<Bool_t> L1_HTT300er_QuadJet_70_55_40_35_er2p5 = {fReader, "L1_HTT300er_QuadJet_70_55_40_35_er2p5"};
   TTreeReaderValue<Bool_t> L1_HTT320er = {fReader, "L1_HTT320er"};
   TTreeReaderValue<Bool_t> L1_HTT340er = {fReader, "L1_HTT340er"};
   TTreeReaderValue<Bool_t> L1_HTT380er = {fReader, "L1_HTT380er"};
   TTreeReaderValue<Bool_t> L1_HTT400er = {fReader, "L1_HTT400er"};
   TTreeReaderValue<Bool_t> L1_HTT450er = {fReader, "L1_HTT450er"};
   TTreeReaderValue<Bool_t> L1_HTT500er = {fReader, "L1_HTT500er"};
   TTreeReaderValue<Bool_t> L1_IsoEG18er2p1_IsoTau24er2p1_dEta_Min0p2 = {fReader, "L1_IsoEG18er2p1_IsoTau24er2p1_dEta_Min0p2"};
   TTreeReaderValue<Bool_t> L1_IsoEG20er2p1_IsoTau25er2p1_dEta_Min0p2 = {fReader, "L1_IsoEG20er2p1_IsoTau25er2p1_dEta_Min0p2"};
   TTreeReaderValue<Bool_t> L1_IsoEG22er2p1_IsoTau26er2p1_dEta_Min0p2 = {fReader, "L1_IsoEG22er2p1_IsoTau26er2p1_dEta_Min0p2"};
   TTreeReaderValue<Bool_t> L1_IsoEG24er2p1_HTT100er = {fReader, "L1_IsoEG24er2p1_HTT100er"};
   TTreeReaderValue<Bool_t> L1_IsoEG24er2p1_Jet26er3p0_dR_Min0p3 = {fReader, "L1_IsoEG24er2p1_Jet26er3p0_dR_Min0p3"};
   TTreeReaderValue<Bool_t> L1_IsoEG24er2p1_TripleJet_26er3p0_26_26er3p0 = {fReader, "L1_IsoEG24er2p1_TripleJet_26er3p0_26_26er3p0"};
   TTreeReaderValue<Bool_t> L1_IsoEG26er2p1_HTT100er = {fReader, "L1_IsoEG26er2p1_HTT100er"};
   TTreeReaderValue<Bool_t> L1_IsoEG26er2p1_Jet34er3p0_dR_Min0p3 = {fReader, "L1_IsoEG26er2p1_Jet34er3p0_dR_Min0p3"};
   TTreeReaderValue<Bool_t> L1_IsoEG28er2p1_HTT100er = {fReader, "L1_IsoEG28er2p1_HTT100er"};
   TTreeReaderValue<Bool_t> L1_IsoEG28er2p1_Jet34er3p0_dR_Min0p3 = {fReader, "L1_IsoEG28er2p1_Jet34er3p0_dR_Min0p3"};
   TTreeReaderValue<Bool_t> L1_IsoEG30er2p1_Jet34er3p0_dR_Min0p3 = {fReader, "L1_IsoEG30er2p1_Jet34er3p0_dR_Min0p3"};
   TTreeReaderValue<Bool_t> L1_IsoTau40er_ETM100 = {fReader, "L1_IsoTau40er_ETM100"};
   TTreeReaderValue<Bool_t> L1_IsoTau40er_ETM80 = {fReader, "L1_IsoTau40er_ETM80"};
   TTreeReaderValue<Bool_t> L1_IsoTau40er_ETM85 = {fReader, "L1_IsoTau40er_ETM85"};
   TTreeReaderValue<Bool_t> L1_IsoTau40er_ETM90 = {fReader, "L1_IsoTau40er_ETM90"};
   TTreeReaderValue<Bool_t> L1_IsoTau40er_ETM95 = {fReader, "L1_IsoTau40er_ETM95"};
   TTreeReaderValue<Bool_t> L1_IsoTau40er_ETMHF80 = {fReader, "L1_IsoTau40er_ETMHF80"};
   TTreeReaderValue<Bool_t> L1_IsoTau40er_ETMHF90 = {fReader, "L1_IsoTau40er_ETMHF90"};
   ...
   TTreeReaderValue<Bool_t> L1_Mu10er2p1_ETM30 = {fReader, "L1_Mu10er2p1_ETM30"};
   ...
   TTreeReaderValue<Bool_t> L1_Mu14er2p1_ETM30 = {fReader, "L1_Mu14er2p1_ETM30"};
   TTreeReaderValue<Bool_t> L1_Mu15_HTT100er = {fReader, "L1_Mu15_HTT100er"};
   TTreeReaderValue<Bool_t> L1_Mu16er2p1_Tau20er2p1 = {fReader, "L1_Mu16er2p1_Tau20er2p1"};
   TTreeReaderValue<Bool_t> L1_Mu16er2p1_Tau24er2p1 = {fReader, "L1_Mu16er2p1_Tau24er2p1"};
   TTreeReaderValue<Bool_t> L1_Mu18_HTT100er = {fReader, "L1_Mu18_HTT100er"};
   TTreeReaderValue<Bool_t> L1_Mu18_Jet24er3p0 = {fReader, "L1_Mu18_Jet24er3p0"};
   TTreeReaderValue<Bool_t> L1_Mu18er2p1_IsoTau26er2p1 = {fReader, "L1_Mu18er2p1_IsoTau26er2p1"};
   TTreeReaderValue<Bool_t> L1_Mu18er2p1_Tau20er2p1 = {fReader, "L1_Mu18er2p1_Tau20er2p1"};
   ...
   TTreeReaderValue<Bool_t> L1_Mu20er2p1_IsoTau26er2p1 = {fReader, "L1_Mu20er2p1_IsoTau26er2p1"};
   ...
   TTreeReaderValue<Bool_t> L1_Mu6_HTT200er = {fReader, "L1_Mu6_HTT200er"};
   ...
   TTreeReaderValue<Bool_t> L1_Mu7_EG23 = {fReader, "L1_Mu7_EG23"};
   TTreeReaderValue<Bool_t> L1_Mu7_IsoEG20 = {fReader, "L1_Mu7_IsoEG20"};
   TTreeReaderValue<Bool_t> L1_Mu7_IsoEG23 = {fReader, "L1_Mu7_IsoEG23"};
   TTreeReaderValue<Bool_t> L1_Mu8_HTT150er = {fReader, "L1_Mu8_HTT150er"};
   TTreeReaderValue<Bool_t> L1_NotBptxOR = {fReader, "L1_NotBptxOR"};
   TTreeReaderValue<Bool_t> L1_QuadJet36er3p0_IsoTau52er2p1 = {fReader, "L1_QuadJet36er3p0_IsoTau52er2p1"};
   TTreeReaderValue<Bool_t> L1_QuadJet36er3p0_Tau52 = {fReader, "L1_QuadJet36er3p0_Tau52"};
   TTreeReaderValue<Bool_t> L1_QuadJet40er3p0 = {fReader, "L1_QuadJet40er3p0"};
   TTreeReaderValue<Bool_t> L1_QuadJet50er3p0 = {fReader, "L1_QuadJet50er3p0"};
   TTreeReaderValue<Bool_t> L1_QuadJet60er3p0 = {fReader, "L1_QuadJet60er3p0"};
   ...
   TTreeReaderValue<Bool_t> L1_SingleEG34er2p1 = {fReader, "L1_SingleEG34er2p1"};
   TTreeReaderValue<Bool_t> L1_SingleEG36 = {fReader, "L1_SingleEG36"};
   TTreeReaderValue<Bool_t> L1_SingleEG36er2p1 = {fReader, "L1_SingleEG36er2p1"};
   TTreeReaderValue<Bool_t> L1_SingleEG38 = {fReader, "L1_SingleEG38"};
   TTreeReaderValue<Bool_t> L1_SingleEG38er2p1 = {fReader, "L1_SingleEG38er2p1"};
   ...
   TTreeReaderValue<Bool_t> L1_SingleIsoEG18er2p1 = {fReader, "L1_SingleIsoEG18er2p1"};
   TTreeReaderValue<Bool_t> L1_SingleIsoEG20 = {fReader, "L1_SingleIsoEG20"};
   TTreeReaderValue<Bool_t> L1_SingleIsoEG20er2p1 = {fReader, "L1_SingleIsoEG20er2p1"};
   TTreeReaderValue<Bool_t> L1_SingleIsoEG22 = {fReader, "L1_SingleIsoEG22"};
   TTreeReaderValue<Bool_t> L1_SingleIsoEG22er2p1 = {fReader, "L1_SingleIsoEG22er2p1"};
   ...
   TTreeReaderValue<Bool_t> L1_SingleIsoEG34er2p1 = {fReader, "L1_SingleIsoEG34er2p1"};
   TTreeReaderValue<Bool_t> L1_SingleIsoEG36 = {fReader, "L1_SingleIsoEG36"};
   TTreeReaderValue<Bool_t> L1_SingleIsoEG36er2p1 = {fReader, "L1_SingleIsoEG36er2p1"};
   TTreeReaderValue<Bool_t> L1_SingleIsoEG38 = {fReader, "L1_SingleIsoEG38"};
   ...
   TTreeReaderValue<Bool_t> L1_SingleJet20er3p0_NotBptxOR = {fReader, "L1_SingleJet20er3p0_NotBptxOR"};
   TTreeReaderValue<Bool_t> L1_SingleJet20er3p0_NotBptxOR_3BX = {fReader, "L1_SingleJet20er3p0_NotBptxOR_3BX"};
   TTreeReaderValue<Bool_t> L1_SingleJet35 = {fReader, "L1_SingleJet35"};
   TTreeReaderValue<Bool_t> L1_SingleJet43er3p0_NotBptxOR_3BX = {fReader, "L1_SingleJet43er3p0_NotBptxOR_3BX"};
   TTreeReaderValue<Bool_t> L1_SingleJet46er3p0_NotBptxOR_3BX = {fReader, "L1_SingleJet46er3p0_NotBptxOR_3BX"};
   ...
   TTreeReaderValue<Bool_t> L1_SingleMu11_LowQ = {fReader, "L1_SingleMu11_LowQ"};
   TTreeReaderValue<Bool_t> L1_SingleMu14er2p1 = {fReader, "L1_SingleMu14er2p1"};
   TTreeReaderValue<Bool_t> L1_SingleMu16 = {fReader, "L1_SingleMu16"};
   TTreeReaderValue<Bool_t> L1_SingleMu16er2p1 = {fReader, "L1_SingleMu16er2p1"};
   TTreeReaderValue<Bool_t> L1_SingleMu18 = {fReader, "L1_SingleMu18"};
   TTreeReaderValue<Bool_t> L1_SingleMu18er2p1 = {fReader, "L1_SingleMu18er2p1"};
   TTreeReaderValue<Bool_t> L1_SingleMu20 = {fReader, "L1_SingleMu20"};
   TTreeReaderValue<Bool_t> L1_SingleMu20er2p1 = {fReader, "L1_SingleMu20er2p1"};
   TTreeReaderValue<Bool_t> L1_SingleMu22 = {fReader, "L1_SingleMu22"};
   TTreeReaderValue<Bool_t> L1_SingleMu22er2p1 = {fReader, "L1_SingleMu22er2p1"};
   ...
   TTreeReaderValue<Bool_t> L1_SingleTau100er2p1 = {fReader, "L1_SingleTau100er2p1"};
   TTreeReaderValue<Bool_t> L1_SingleTau120er2p1 = {fReader, "L1_SingleTau120er2p1"};
   TTreeReaderValue<Bool_t> L1_SingleTau20 = {fReader, "L1_SingleTau20"};
   TTreeReaderValue<Bool_t> L1_SingleTau80er2p1 = {fReader, "L1_SingleTau80er2p1"};
   ...
   TTreeReaderValue<Bool_t> L1_TripleEG_Iso20_10_5 = {fReader, "L1_TripleEG_Iso20_10_5"};
   ...
   TTreeReaderValue<Bool_t> L1_TripleMu_4_4_4 = {fReader, "L1_TripleMu_4_4_4"};
   TTreeReaderValue<Bool_t> L1_TripleMu_5_0_0 = {fReader, "L1_TripleMu_5_0_0"};
   TTreeReaderValue<Bool_t> L1_TripleMu_5_0_0_DoubleMu_5_0_OS_Mass_Max17 = {fReader, "L1_TripleMu_5_0_0_DoubleMu_5_0_OS_Mass_Max17"};
   TTreeReaderValue<Bool_t> L1_TripleMu_5_3_0_DoubleMu_5_3_OS_Mass_Max17 = {fReader, "L1_TripleMu_5_3_0_DoubleMu_5_3_OS_Mass_Max17"};
   ...
   TTreeReaderValue<Bool_t> Flag_HBHENoiseFilter_pRECO = {fReader, "Flag_HBHENoiseFilter_pRECO"};
   TTreeReaderValue<Bool_t> Flag_HBHENoiseIsoFilter_pRECO = {fReader, "Flag_HBHENoiseIsoFilter_pRECO"};
   TTreeReaderValue<Bool_t> Flag_CSCTightHaloFilter_pRECO = {fReader, "Flag_CSCTightHaloFilter_pRECO"};
   TTreeReaderValue<Bool_t> Flag_CSCTightHaloTrkMuUnvetoFilter_pRECO = {fReader, "Flag_CSCTightHaloTrkMuUnvetoFilter_pRECO"};
   TTreeReaderValue<Bool_t> Flag_CSCTightHalo2015Filter_pRECO = {fReader, "Flag_CSCTightHalo2015Filter_pRECO"};
   TTreeReaderValue<Bool_t> Flag_globalTightHalo2016Filter_pRECO = {fReader, "Flag_globalTightHalo2016Filter_pRECO"};
   TTreeReaderValue<Bool_t> Flag_globalSuperTightHalo2016Filter_pRECO = {fReader, "Flag_globalSuperTightHalo2016Filter_pRECO"};
   TTreeReaderValue<Bool_t> Flag_HcalStripHaloFilter_pRECO = {fReader, "Flag_HcalStripHaloFilter_pRECO"};
   TTreeReaderValue<Bool_t> Flag_hcalLaserEventFilter_pRECO = {fReader, "Flag_hcalLaserEventFilter_pRECO"};
   TTreeReaderValue<Bool_t> Flag_EcalDeadCellTriggerPrimitiveFilter_pRECO = {fReader, "Flag_EcalDeadCellTriggerPrimitiveFilter_pRECO"};
   TTreeReaderValue<Bool_t> Flag_EcalDeadCellBoundaryEnergyFilter_pRECO = {fReader, "Flag_EcalDeadCellBoundaryEnergyFilter_pRECO"};
   TTreeReaderValue<Bool_t> Flag_ecalBadCalibFilter_pRECO = {fReader, "Flag_ecalBadCalibFilter_pRECO"};
   TTreeReaderValue<Bool_t> Flag_goodVertices_pRECO = {fReader, "Flag_goodVertices_pRECO"};
   TTreeReaderValue<Bool_t> Flag_eeBadScFilter_pRECO = {fReader, "Flag_eeBadScFilter_pRECO"};
   TTreeReaderValue<Bool_t> Flag_ecalLaserCorrFilter_pRECO = {fReader, "Flag_ecalLaserCorrFilter_pRECO"};
   TTreeReaderValue<Bool_t> Flag_trkPOGFilters_pRECO = {fReader, "Flag_trkPOGFilters_pRECO"};
   TTreeReaderValue<Bool_t> Flag_chargedHadronTrackResolutionFilter_pRECO = {fReader, "Flag_chargedHadronTrackResolutionFilter_pRECO"};
   TTreeReaderValue<Bool_t> Flag_muonBadTrackFilter_pRECO = {fReader, "Flag_muonBadTrackFilter_pRECO"};
   TTreeReaderValue<Bool_t> Flag_BadChargedCandidateFilter_pRECO = {fReader, "Flag_BadChargedCandidateFilter_pRECO"};
   TTreeReaderValue<Bool_t> Flag_BadPFMuonFilter_pRECO = {fReader, "Flag_BadPFMuonFilter_pRECO"};
   TTreeReaderValue<Bool_t> Flag_BadChargedCandidateSummer16Filter_pRECO = {fReader, "Flag_BadChargedCandidateSummer16Filter_pRECO"};
   TTreeReaderValue<Bool_t> Flag_BadPFMuonSummer16Filter_pRECO = {fReader, "Flag_BadPFMuonSummer16Filter_pRECO"};
   TTreeReaderValue<Bool_t> Flag_trkPOG_manystripclus53X_pRECO = {fReader, "Flag_trkPOG_manystripclus53X_pRECO"};
   TTreeReaderValue<Bool_t> Flag_trkPOG_toomanystripclus53X_pRECO = {fReader, "Flag_trkPOG_toomanystripclus53X_pRECO"};
   TTreeReaderValue<Bool_t> Flag_trkPOG_logErrorTooManyClusters_pRECO = {fReader, "Flag_trkPOG_logErrorTooManyClusters_pRECO"};
   TTreeReaderValue<Bool_t> Flag_METFilters_pRECO = {fReader, "Flag_METFilters_pRECO"};
   ...
   TTreeReaderValue<Bool_t> L1_ETMHF100_HTT60 = {fReader, "L1_ETMHF100_HTT60"};
   TTreeReaderValue<Bool_t> L1_ETMHF110_HTT60 = {fReader, "L1_ETMHF110_HTT60"};
   TTreeReaderValue<Bool_t> L1_ETMHF120_HTT60 = {fReader, "L1_ETMHF120_HTT60"};
   TTreeReaderValue<Bool_t> L1_ETMHF80_HTT60 = {fReader, "L1_ETMHF80_HTT60"};
   TTreeReaderValue<Bool_t> L1_ETMHF90_HTT60 = {fReader, "L1_ETMHF90_HTT60"};
   TTreeReaderValue<Bool_t> L1_SingleJet35_HFm = {fReader, "L1_SingleJet35_HFm"};
   TTreeReaderValue<Bool_t> L1_SingleJet35_HFp = {fReader, "L1_SingleJet35_HFp"};
   TTreeReaderValue<Bool_t> L1_SingleJet60_HFm = {fReader, "L1_SingleJet60_HFm"};
   TTreeReaderValue<Bool_t> L1_SingleJet60_HFp = {fReader, "L1_SingleJet60_HFp"};
   ...
   TTreeReaderValue<Bool_t> L1_SingleMu12_LowQ_BMTF = {fReader, "L1_SingleMu12_LowQ_BMTF"};
   TTreeReaderValue<Bool_t> L1_SingleMu12_LowQ_EMTF = {fReader, "L1_SingleMu12_LowQ_EMTF"};
   TTreeReaderValue<Bool_t> L1_SingleMu12_LowQ_OMTF = {fReader, "L1_SingleMu12_LowQ_OMTF"};
   ...
   ../VariableLists/DATA_2017(TTree * /*tree*/ =0) { }
   virtual ~../VariableLists/DATA_2017() { }
   ...
   ClassDef(../VariableLists/DATA_2017,0);

};

#endif

#ifdef ../VariableLists/DATA_2017_cxx
void ../VariableLists/DATA_2017::Init(TTree *tree)
{
...
Bool_t ../VariableLists/DATA_2017::Notify()
{
...
#endif // #ifdef ../VariableLists/DATA_2017_cxx

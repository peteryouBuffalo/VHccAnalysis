...
def write_condor_config(workDir, sample_format, sample_subformat, nanoaod_format, 
  ...
  f.write('make FORMAT='+sample_format+ ' SUBFORMAT=' + sample_subformat+' PROCESSING=NORMAL NANOAOD='+nanoaod_format+' INPUT=TCHAIN'+'\n')

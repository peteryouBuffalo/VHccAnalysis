...
./main -filelist FileLists_test/WZTo4Q_NLO_MC_2016.txt -out Tmp/output_WZTo4Q_NLO_MC_2016.txt.root -data 0 -year 2016 -syst NONE -xccEffFileName CalibData/xcc_eff_VH_looseWP.root -centralGenWeight 0 -lastentry 10000 

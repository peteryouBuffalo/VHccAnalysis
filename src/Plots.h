...
class VHBoostedPlots
{
  ...
  public:
    ...
    VHBoostedPlots(TString name, int iPdfStart=0, int iPdfStop=0, int nLHEscales=0) : m_name(name) {
      ...
      h_HMass_VZqqcc = new TH1D(name + "_HMass_VZqqcc", "", NBIN_M_H, X_M_H[0], X_M_H[1]);
      h_HMass_VZqccc = new TH1D(name + "_HMass_VZqccc", "", NBIN_M_H, X_M_H[0], X_M_H[1]);
      h_HMass_VZcccc = new TH1D(name + "_HMass_VZcccc", "", NBIN_M_H, X_M_H[0], X_M_H[1]);
      h_HMass_VZbbcc = new TH1D(name + "_HMass_VZbbcc", "", NBIN_M_H, X_M_H[0], X_M_H[1]);
      h_HMass_VZqqbb = new TH1D(name + "_HMass_VZqqbb", "", NBIN_M_H, X_M_H[0], X_M_H[1]);
      ...
      h_HMass_VZqqcc->Sumw2();
      h_HMass_VZqccc->Sumw2();
      h_HMass_VZcccc->Sumw2();
      h_HMass_VZbbcc->Sumw2();
      h_HMass_VZqqbb->Sumw2();
    ...
    // Fill the general histograms.
    //VZtype is used to separate VZ events to qqcc, cccc, bbcc, qqbb, bbbb, qqqq 
    //VZtype = 3^2*4^2 = : qqcc 
    //VZtype = 3*4*4^2 = : qccc 
    //VZtype = 4^4    : cccc 
    //VZtype = 5^2*4^2: bbcc 
    ...
    //VZtype = 5^4    : bbbb 
    //VZtype = 3^4    : qqqq 
    //VZtype = 1: not a VZ all-hadronic event 
    void Fill(HObj& H, ZObj& Z, int VZtype=1, float w=1) {
    ...
    std::vector<TH1*> returnHisto() {
      ...
      histolist.push_back(h_HMass_VZqqcc);
      histolist.push_back(h_HMass_VZqccc);
      histolist.push_back(h_HMass_VZcccc);
      histolist.push_back(h_HMass_VZbbcc);
      histolist.push_back(h_HMass_VZqqbb);

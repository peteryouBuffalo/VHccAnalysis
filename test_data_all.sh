#!/bin/bash 
make FORMAT=DATA_2016 SUBFORMAT=DATA_2016B PROCESSING=NORMAL NANOAOD=NANOAODV9 INPUT=TCHAIN
...
make FORMAT=DATA_2016 SUBFORMAT=DATA_2016F PROCESSING=NORMAL NANOAOD=NANOAODV9 INPUT=TCHAIN
...
make FORMAT=DATA_2017 SUBFORMAT=DATA_2017B PROCESSING=NORMAL NANOAOD=NANOAODV9 INPUT=TCHAIN
...
make FORMAT=DATA_2018 SUBFORMAT=DATA_2018B PROCESSING=NORMAL NANOAOD=NANOAODV9 INPUT=TCHAIN

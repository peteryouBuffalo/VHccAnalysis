#!/bin/bash 
make FORMAT=DATA_2016 SUBFORMAT=DATA_2016B SAMPLE=MC_NOTVZ PROCESSING=NORMAL NANOAOD=NANOAODV9 INPUT=TCHAIN
...
make FORMAT=DATA_2016 SUBFORMAT=DATA_2016F SAMPLE=MC_NOTVZ PROCESSING=NORMAL NANOAOD=NANOAODV9 INPUT=TCHAIN
...
make FORMAT=DATA_2017 SUBFORMAT=DATA_2017B SAMPLE=MC_NOTVZ PROCESSING=NORMAL NANOAOD=NANOAODV9 INPUT=TCHAIN
...
make FORMAT=DATA_2018 SUBFORMAT=DATA_2018B SAMPLE=MC_NOTVZ PROCESSING=NORMAL NANOAOD=NANOAODV9 INPUT=TCHAIN
